...
# This calculator will allow users to perform basic arithmetic operations such as addition, subtraction,
# multiplication, and division. It will take two numbers as input and an operator to specify the desired
